        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        blank=True, max_length=254, verbose_name="visitor"
                    ),
                ),
                (
                    "sent_at",
                ...
                (
                    "sender_archived",
                    models.BooleanField(
                        default=False, verbose_name="archived by sender"
                    ),
                ),
                (
                    "recipient_archived",
                    models.BooleanField(
                        default=False, verbose_name="archived by recipient"
                    ),
                ),
                (
                    "sender_deleted_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="deleted by sender at"
                    ),
                ),
                (
                    "recipient_deleted_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="deleted by recipient at"
                    ),
                ),
                (
                    "moderation_status",
                ...
                (
                    "moderation_reason",
                    models.CharField(
                        blank=True, max_length=120, verbose_name="rejection reason"
                    ),
                ),
                (
                    "moderation_by",

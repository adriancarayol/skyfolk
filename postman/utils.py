...
if name and name in settings.INSTALLED_APPS:
    ...
    if (
        ...
        def send_mail(subject, message, from_email, recipient_list, **kwargs):
            ...
            if html_message:
                return mailer_send_html_mail(
                    subject, message, html_message, from_email, recipient_list, **kwargs
                )
            else:
...
def email(
    subject_template, message_template_name, recipient_list, object, action, site
):

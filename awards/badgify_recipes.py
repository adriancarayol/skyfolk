...
class FirstLoginRecipe(BaseRecipe):
    ...
    slug = "new-account"
    description = (
        "¡Bienvenido a Skyfolk! - Has obtenido este logro al registrarte exitosamente."
    )
    points = 5
    category = "hero"
...
class FirstPublicationRecipe(BaseRecipe):
    ...
    description = (
        "Has obtenido este logro por realizar tu primera publicación en Skyfolk."
    )
    points = 5
    category = "writer"
...
class FirstDirectMessageRecipe(BaseRecipe):
    ...
    description = (
        "Has obtenido este logro por realizar tu primer mensaje privado en Skyfolk."
    )
    points = 25
    category = "hero"
    ...
    def image(self):
        return os.path.join(
            settings.STATIC_URL, "badges/outline_mail_outline_black_18dp.png"
        )
...
class FirstMediaRecipe(BaseRecipe):
    ...
    def image(self):
        return os.path.join(
            settings.STATIC_URL, "badges/baseline_cloud_upload_black_18dp.png"
        )
...
class CasanovaRecipe(BaseRecipe):
    ...
    description = (
        "Has obtenido este logro por subir recibir 100 me gusta a tu perfil en Skyfolk."
    )
    points = 15
    category = "star"
...
class DonJuanRecipe(BaseRecipe):
    ...
    def image(self):
        return os.path.join(
            settings.STATIC_URL, "badges/baseline_star_half_black_18dp.png"
        )
...
class PulitzerRecipe(BaseRecipe):
    ...
    def image(self):
        return os.path.join(
            settings.STATIC_URL, "badges/baseline_thumb_up_black_18dp.png"
        )

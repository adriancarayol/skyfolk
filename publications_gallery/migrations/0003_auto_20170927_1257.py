# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-27 10:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('publications_gallery', '0002_auto_20170921_1711'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='board_video', to='photologue.Photo')),
                ...
                ('user_share_me', models.ManyToManyField(blank=True, related_name='share_video_me', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },

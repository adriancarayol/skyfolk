...
from publications_groups.themes.models import (
    PublicationThemeVideo,
    PublicationThemeImage,
)
        ...
        for index, media in enumerate(image_upload):
            try:
                if exts[index][0] == "video":  # es un video
                    if exts[index][1] == "mp4":
                        PublicationThemeVideo.objects.create(
                    ...
                    PublicationThemeImage.objects.create(

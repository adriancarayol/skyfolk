...
class PublicationGroupTestCase(TestCase):
    def setUp(self):
        ...
        g = UserGroups.objects.create(name="test", description="test",
                                      owner=u)
        PublicationGroup.objects.create(author=u, board_group=g, content="YEE")

    def test_create_publication(self):
        u = User.objects.get(username="test")
        g = UserGroups.objects.get(name="test", description="test",
                                   owner=u)
    ...
    def test_extra_content(self):
        ...
        e = ExtraGroupContent.objects.create(publication=pub, title="Extra content example")

...
from th_services.th_slack.forms import SlackConsumerForm
from th_services.th_slack.models import Slack
from th_services.th_slack.my_slack import ServiceSlack
...
class SlackFormTest(SlackTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_slack.my_slack.ServiceSlack',)

...
from th_services.th_evernote.forms import EvernoteProviderForm, EvernoteConsumerForm
from th_services.th_evernote.my_evernote import ServiceEvernote
from th_services.th_evernote.evernote_mgr import EvernoteMgr
from th_services.th_evernote.sanitize import sanitize
...
class EvernoteView(EvernoteTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_evernote.my_evernote.ServiceEvernote',)

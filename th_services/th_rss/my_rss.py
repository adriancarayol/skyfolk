...
# th_rss classes
from th_services.th_rss.lib.feedsservice import Feeds
...
class ServiceRss(ServicesMgr):
    ...
    def read_data(self, **kwargs):
        ...
        cache.set('th_services.th_rss_' + str(trigger_id), my_feeds)
        cache.set('th_services.th_rss_uuid_{}'.format(rss.uuid), my_feeds)
        # return the data
        return my_feeds
...
from th_services.th_rss.forms import RssProviderForm
from th_services.th_rss.models import Rss
from th_services.th_rss.views import MyRssFeed, MyRssFeeds
...
class RssFormTest(RssTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_rss.my_rss.ServiceRss',)
        for service in th_service:
            self.assertIn(service, settings.TH_SERVICES)

    def test_read_data(self):
        r = self.create_rss()
        from th_services.th_rss.my_rss import ServiceRss
...
class TestMyRssFeed(RssTest):
    ...
    def test_context_data(self):
        ...
        context['version'] = skyfolk.__version__

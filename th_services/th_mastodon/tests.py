...
from th_services.th_mastodon.forms import MastodonProviderForm, MastodonConsumerForm
from th_services.th_mastodon.models import Mastodon
from th_services.th_mastodon.my_mastodon import ServiceMastodon
...
class MastodonTest(MainTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_mastodon.my_mastodon.ServiceMastodon',)

...
from th_services.th_twitter.forms import TwitterProviderForm, TwitterConsumerForm
from th_services.th_twitter.my_twitter import ServiceTwitter
...
class TwitterTest(MainTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_twitter.my_twitter.ServiceTwitter',)

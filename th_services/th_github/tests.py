...
from th_services.th_github.forms import GithubProviderForm, GithubConsumerForm
from th_services.th_github.my_github import ServiceGithub
...
class GithubModelAndFormTest(GithubTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_github.my_github.ServiceGithub',)
...
class ServiceGithubTest(GithubTest):
    ...
    def test_read_data(self):
        ...
        data = []
        cache.set('th_services.th_github_' + str(trigger_id), data)

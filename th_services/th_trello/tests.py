...
from th_services.th_trello.forms import TrelloProviderForm, TrelloConsumerForm
from th_services.th_trello.my_trello import ServiceTrello
...
class TrelloModelAndFormTest(TrelloTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_trello.my_trello.ServiceTrello',)

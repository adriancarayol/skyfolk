...
from th_services.th_pocket.forms import PocketProviderForm, PocketConsumerForm
from th_services.th_pocket.models import Pocket as PocketModel
from th_services.th_pocket.my_pocket import ServicePocket
...
class PocketModelAndFormTest(PocketTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_pocket.my_pocket.ServicePocket',)

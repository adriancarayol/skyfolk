...
from th_services.th_taiga.models import Taiga
from th_services.th_taiga.forms import TaigaProviderForm
from th_services.th_taiga.my_taiga import ServiceTaiga
...
class TaigaFormTest(TaigaTest):
    ...
    def test_get_services_list(self):
        th_service = ('th_services.th_taiga.my_taiga.ServiceTaiga',)

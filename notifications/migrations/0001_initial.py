    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('success', 'success'), ('info', 'info'), ('warning', 'warning'), ('error', 'error'), ('friendrequest', 'friendrequest')], default='info', max_length=20)),
                ('unread', models.BooleanField(default=True)),
                ('actor_object_id', models.CharField(max_length=255)),
                ('actor_avatar', models.CharField(blank=True, max_length=255, null=True)),

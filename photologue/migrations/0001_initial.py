    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transpose_method', models.CharField(blank=True, choices=[('FLIP_LEFT_RIGHT', 'Flip left to right'), ('FLIP_TOP_BOTTOM', 'Flip top to bottom'), ('ROTATE_90', 'Rotate 90 degrees counter-clockwise'), ('ROTATE_270', 'Rotate 90 degrees clockwise'), ('ROTATE_180', 'i 180 degrees')], max_length=15, verbose_name='rotate or flip')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, upload_to=photologue.models.upload_thumbnail_video, verbose_name='thumbnail')),
        ...
        migrations.AddField(
            model_name='photo',
            name='owner',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_photos', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='photo',
            name='sites',

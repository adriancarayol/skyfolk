...
class Gallery(models.Model):
    ...
    owner = models.ForeignKey(User, related_name='gallery_owner', null=False, blank=False)
...
class Photo(ImageModel):
    ...
    owner = models.ForeignKey(User, related_name='photo_owner', null=False, blank=False)

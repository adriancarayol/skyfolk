$(document).ready(function () {
    ...
    $('#del-photo').click(AJAX_delete_group_photo);

    $('#del-video').click(AJAX_delete_group_video);


    $("#edit-photo, #edit-video").click(function () {
...
function AJAX_delete_group_photo() {
    var _id = $('.photo-body').attr('data-id');
    console.log(_id);
    $.ajax({
        url: '/group/delete/photo/',
        type: 'DELETE',
        data: {
            'id': _id,
...
/* DELETE VIDEO */
function AJAX_delete_group_video() {
    var _id = $('.photo-body').attr('data-id');
    $.ajax({
        url: '/group/delete/video/',
        type: 'DELETE',
        data: {
            'id': _id,
            'csrfmiddlewaretoken': csrftoken

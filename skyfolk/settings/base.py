...
ALLOWED_TAGS = (
    "p div br code pre h1 h2 h3 h4 hr span s sub "
...
GRAPHENE = {"SCHEMA": "skyfolk.schema.schema"}
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "skyfolk/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# STATIC_URL = '/static/'
STATICFILES_DIRS = (os.path.join(BASE_DIR, "skyfolk/static"),)
...
# CKEDITOR
CKEDITOR_CONFIGS = {"default": {"toolbar": "full", "width": "auto"}}

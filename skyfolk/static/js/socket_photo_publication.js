            ...
            socket.onmessage = function (message) {
                ...
                if (data.type === "pub") {
                    if (!data.is_edited) {
                        ...
                        content += '        <div class="usr-img img-responsive"><img src="' + data.avatar_path + '" alt="' + data.p_author_username + '" width="120" height="120"></div>';
                        content += "      </div>";
                        content += '<div class="col l10 m12 s9">';
                        content += '                  <h2 class="h22"><a href="/profile/' + data.p_author_username + '" >@' + data.p_author_username + '</a>';
                        if (data.parent) {
                        ...
                        if (data.event_type === 6) {
                            ...
                            content += '<img src="' + data.shared_publication_avatar_path + '" alt="' + data.shared_publication_p_author_username + '" width="70" height="70" style="box-shadow: 0 1px 5px rgba(30, 136, 229, 0.15);"><br>';
                            content += '<span class="card-title"><a href="/profile/' + data.shared_publication_p_author_username + '">@' + data.shared_publication_p_author_username + '</a>';
                            ...
                            if (typeof(data.shared_publication_images) !== 'undefined' && data.shared_publication_images !== null && data.shared_publication_images.length > 0) {
                                ...
                                for (var image = 0; image < data.shared_publication_images.length; image++) {
                                    ...
                                    content += '<img class="responsive-img" src="/media/' + data.shared_publication_images[image].image + '" alt="Imagen de: ' + data.shared_publication_p_author_username + '" title="Imagen de: ' + data.shared_publication_p_author_username + '">';
                                    content += "                    </div>";
                                }
                                content += "                    </div>";
                            }
                        ...
                        if (data.event_type === 7) {
                            ...
                            content += '<div class="card grey lighten-5">';
                            content += '<div class="card-content black-text">';
                            content += '<img src="' + data.shared_photo_publication_avatar_path + '" alt="' + data.shared_photo_publication_p_author_username + '" width="70" height="70" style="box-shadow: 0 1px 5px rgba(30, 136, 229, 0.15);"><br>';
                            content += '<span class="card-title"><a href="/profile/' + data.shared_photo_publication_p_author_username + '">@' + data.shared_photo_publication_p_author_username + '</a>';
                            ...
                            if (typeof(data.shared_photo_publication_images) !== 'undefined' && data.shared_photo_publication_images !== null && data.shared_photo_publication_images.length > 0) {
                                ...
                                for (var image = 0; image < data.shared_photo_publication_images.length; image++) {
                                    content += '<div class="col s4 z-depth-2">';
                                    content += '<img class="responsive-img" src="/media/' + data.shared_photo_publication_images[image].image + '" alt="Imagen de: ' + data.shared_photo_publication_p_author_username + '" title="Imagen de: ' + data.shared_photo_publication_p_author_username + '">';
                                    content += "                    </div>";
                                }
                                content += "                    </div>";
                            }
                        ...
                        if (typeof(data.images) !== 'undefined' && data.images !== null && data.images.length > 0) {
                            ...
                            for(var image = 0; image < data.images.length; image++) {
                                content += '<div class="col s4 z-depth-2">';
                                content += '<img class="responsive-img" src="/media/'+data.images[image].image+'" alt="Imagen de: '+data.p_author_username+'" title="Imagen de: '+data.p_author_username+'">';
                                content += "                    </div>";
                            }
                            content += "                    </div>";
                        }
                        ...
                        content += '<div class="row">';
                        content += '<div class="input-field col s12">';
                        content += '<textarea class="materialize-textarea message-reply" id="message-reply-' + data.id + '" cols="40" maxlength="500" name="content" placeholder="Responder a @' + data.p_author_username + '" rows="10" required=""></textarea>';

# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-22 21:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter_ok', models.IntegerField(default=0)),
                ('counter_ko', models.IntegerField(default=0)),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='skyfolk.ServicesActivated', to_field='name')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            ...
            name='consumer',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='skyfolk.UserService'),
        ),
        migrations.AddField(
            model_name='triggerservice',
            name='provider',

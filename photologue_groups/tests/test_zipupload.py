...
class GalleryUploadTest(TestCase):
    ...
    def setUp(self):
        ...
        user = User.objects.create_user("john.doe", "john.doe@example.com", "secret")
        user.is_staff = True
        user.save()
    ...
    def test_breadcrumbs(self):
        ...
        self.assertContains(
            response,
            """<div class="breadcrumbs"><a href="/admin/">Home</a> &rsaquo;
            <a href="/admin/photologue/">Photologue</a> &rsaquo; Photos &rsaquo; Upload </div>""",
            html=True,
        )
    ...
    def test_good_data(self):
        ...
        self.assertQuerysetEqual(
            Gallery.objects.all(), ["<Gallery: This is a test title>"]
        )
        self.assertQuerysetEqual(
            Photo.objects.all(), ["<Photo: This is a test title 1>"]
        )

        # The photo is attached to the publications_gallery.
        gallery = Gallery.objects.get(title="This is a test title")
        self.assertQuerysetEqual(
            gallery.photos.all(), ["<Photo: This is a test title 1>"]
        )
    ...
    def test_not_image(self):
        ...
        with open(SAMPLE_NOT_IMAGE_ZIP_PATH, mode="rb") as f:
            ...
            response = self.client.post(
                "/admin/photologue/photo/upload_zip/", test_data
            )
    ...
    def test_existing_gallery(self):
        ...
        self.assertQuerysetEqual(Gallery.objects.all(), ["<Gallery: Existing>"])
        self.assertQuerysetEqual(Photo.objects.all(), ["<Photo: Existing 1>"])

        # The photo is attached to the existing publications_gallery.
        self.assertQuerysetEqual(existing_gallery.photos.all(), ["<Photo: Existing 1>"])
    ...
    def test_existing_gallery_custom_title(self):
        ...
        self.assertQuerysetEqual(Photo.objects.all(), ["<Photo: Custom title 1>"])

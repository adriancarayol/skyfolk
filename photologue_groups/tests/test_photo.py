...
class PhotoTest(PhotologueBaseTest):
    ...
    def test_new_photo(self):
        ...
        self.assertEqual(
            self.pl.image.storage.size(self.pl.image.name),
    ...
    def test_paths(self):
        self.assertEqual(
            ...
            os.path.normpath(os.path.join(PHOTOLOGUE_DIR, "photos", "cache")).lower(),
        )
        self.assertEqual(
            self.pl.cache_url(), settings.MEDIA_URL + PHOTOLOGUE_DIR + "/photos/cache"
        )
    ...
    def test_precache(self):
        ...
        self.assertTrue(
            self.pl.image.storage.exists(self.pl.get_testPhotoSize_filename())
        )
    ...
    def test_accessor_methods(self):
        ...
        self.assertEqual(
            self.pl.get_testPhotoSize_size(),
            Image.open(
                self.pl.image.storage.open(self.pl.get_testPhotoSize_filename())
            ).size,
        )
        self.assertEqual(
            self.pl.get_testPhotoSize_url(),
    ...
    def test_unicode(self):
        ...
        self.pl2 = PhotoFactory(title="É", slug="é")
...
class PreviousNextTest(PhotologueBaseTest):
    ...
    def test_previous_simple(self):
        ...
        self.assertEqual(self.pl1.get_previous_in_gallery(self.test_gallery), None)
        self.assertEqual(self.pl2.get_previous_in_gallery(self.test_gallery), self.pl1)
        self.assertEqual(self.pl3.get_previous_in_gallery(self.test_gallery), self.pl2)
    ...
    def test_previous_public(self):
        ...
        self.assertEqual(self.pl3.get_previous_in_gallery(self.test_gallery), self.pl1)
    ...
    def test_next_simple(self):
        ...
        self.assertEqual(self.pl1.get_next_in_gallery(self.test_gallery), self.pl2)
        self.assertEqual(self.pl2.get_next_in_gallery(self.test_gallery), self.pl3)
        self.assertEqual(self.pl3.get_next_in_gallery(self.test_gallery), None)
    ...
    def test_next_public(self):
        ...
        self.assertEqual(self.pl1.get_next_in_gallery(self.test_gallery), self.pl3)
        self.assertRaisesMessage(
            ValueError,
            "Cannot determine neighbours of a non-public photo.",
...
class ImageModelTest(PhotologueBaseTest):
    def setUp(self):
        ...
        self.pu.image.save(
            os.path.basename(UNICODE_IMAGE_PATH),
        ...
        self.pn.image.save(
            os.path.basename(NONSENSE_IMAGE_PATH),
    ...
    @unittest.skipUnless(
        os.path.exists(UNICODE_IMAGE_PATH),

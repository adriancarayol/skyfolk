    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_different_layouts', models.BooleanField(default=True, help_text='Allows you to use different layouts for each workspace.', verbose_name='Allow different layouts per workspace?')),

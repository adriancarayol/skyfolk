...
__all__ = ("BasePollWidget", "Poll1x1Widget")
...
class BasePollWidget(BaseDashboardPluginWidget):
    ...
    def render(self, request=None):
        ...
        poll = DashboardEntry.objects.get(
        ...
        poll_responses = PollResponse.objects.filter(poll=poll).values_list(
            "options", flat=True
        )
        responses = {
        ...
        return render_to_string(
            "poll/render.html", context, request=self.plugin.request
        )

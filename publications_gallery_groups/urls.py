...
urlpatterns = [
    ...
    url(r'^publication/detail/(?P<publication_id>\d+)/$', views.publication_detail,
        name='publication_photo_detail'),
    url(r'^publication/delete/$', views.delete_publication,
        name='delete_photo_publication'),
    url(r'^publication/add_like/$', views.add_like,
        name='add_like_photo_publication'),
    url(r'^publication/add_hate/$', views.add_hate,
        name='add_hate_photo_publication'),
    url(r'^publication/edit/$', views.edit_publication,
        name='publication_edit_photo_pub'),
    url(r'^publication/load_descendants/$', views.load_more_descendants,

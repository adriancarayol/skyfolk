...
class PublicationGalleryTestCase(TestCase):
    def setUp(self):
        ...
        PublicationGroupMediaPhoto.objects.create(content='example_content', author=u, board_photo=p)
    ...
    def test_extra_content(self):
        pub = PublicationGroupMediaPhoto.objects.filter(author__username="example").first()

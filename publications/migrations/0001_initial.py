...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('publications_gallery', '__first__'),
        ('publications_groups', '__first__'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.IntegerField(choices=[(1, 'publication'), (2, 'new_relation'), (3, 'link'), (4, 'relevant'), (5, 'imagen'), (6, 'shared'), (7, 'shared_photo_pub'), (8, 'shared_group_pub')], default=1)),
                ...
                ('shared_group_publication', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='publications_groups.PublicationGroup')),
                ('shared_photo_publication', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='publications_gallery.PublicationPhoto')),
                ('shared_publication', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='publications.Publication')),

...
class Badge(models.Model):
    ...
    name = models.CharField(
        max_length=255, verbose_name=_("name"), help_text=_("The badge name")
    )
    ...
    description = models.TextField(
        blank=True, verbose_name=_("description"), help_text=_("The badge description")
    )
    ...
    users_count = models.IntegerField(
        default=0, verbose_name=_("users count"), editable=False
    )
